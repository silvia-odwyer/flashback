 ...
 */
    ...
    const offset_imgdata = () => {
        for (i = 0; i < imgData.data.length; i += 4) {
            var offset = 5;
            imgData.data[i] = imgData.data[i+4*offset] == undefined ? 0 : imgData.data[i+4*offset];
        }
        return imgData;
    }
